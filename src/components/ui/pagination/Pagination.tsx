...

{
    allPages.map(  (page) => (
          <li key={ page } className="page-item active">
            <Link
            className={ clsx(
              `page-link relative block py-1.5 px-3 border-0 outline-none transition-all duration-300 rounded text-white hover:text-white hover:bg-blue-600 shadow-md focus:shadow-md`,
              {
